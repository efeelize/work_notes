...
| 禁止令 | 管制、缓刑执行之日，违反按照治安管理处罚法 | S 管制,cuz针对的是未被实际关押的人 | ！cuz禁止令是在判决时做出的，假释是在刑罚执行期间的 | X  |
...
| 特殊类型犯罪 | 可以+限制减刑：杀、强、抢、绑、火、爆炸（有组织的暴力犯罪）、投毒/危、累犯 | N | 对象！incl:S 限制减刑+10years 以上（一罪 or 数罪） | N | N | N  | 违反+情节严重==拒不执行判决、裁定罪 |
